...
class keylogger extends Component {
  constructor(props) {
    super(props);
    this.state = { value: [], keyDown: this.props.keyDown };
  }
  ...
  componentWillUpdate(nextProps, nextState) {
    ...
    if (nextProps.data > 47 && nextProps.data <= 90) {
      ...
      nextState.value = [...nextState.value, 'keyCode: ' + String(nextProps.data)];
    }
      ...
      <div>
        ...
        <p>
          <textarea
            ...
            value={"Button " + keyboardMap[Number(this.state.keyDown)]}
          ></textarea>
        </p>
